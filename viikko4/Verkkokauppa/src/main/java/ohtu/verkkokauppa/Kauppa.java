...
public class Kauppa {
    ...
    public void poistaKorista(int id) {
        Tuote tuotePoistettavaksi = varasto.haeTuote(id); 
        if (tuotePoistettavaksi != null) {
            ostoskori.poista(tuotePoistettavaksi);
            varasto.palautaVarastoon(tuotePoistettavaksi);
        }
    }
